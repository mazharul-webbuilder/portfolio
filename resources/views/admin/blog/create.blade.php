                    ...
                    <div class="card-body">
                        <form id="blogCreateForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="title" id="horizontal-firstname-input" placeholder="Enter blog title">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Time to read (in minutes)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="time_to_read" id="horizontal-firstname-input" placeholder="Enter minutes here">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Description</label>
                                <div class="col-sm-9">
                                    <textarea placeholder="Enter blog detail here" class="form-control" name="description" id="horizontal-firstname-input" cols="30" rows="4"></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-9">
                                    <div>
                                        <button type="submit" class="btn btn-primary w-md">Post</button>
                                    </div>
                                </div>
                            </div>
                        </form>
