                    ...
                    <div class="card-body">
                        <form id="SkillUpdateForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$skill->title}}" class="form-control" name="title" id="horizontal-firstname-input" placeholder="Enter here">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Value</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{{$skill->value}}" name="value" id="horizontal-firstname-input" placeholder="Enter here">
                                </div>
                            </div>
