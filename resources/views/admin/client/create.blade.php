        ...
        <div class="row" style="margin-top: 80px">
            <div class="col-md-12">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0 text-light">Client Create</h2>
                    ...
                    <div class="card-body">
                        <form id="clientCreateForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" id="horizontal-firstname-input" placeholder="Ex: Pepsi">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Client Logo</label>
                                <div class="col-sm-9">
